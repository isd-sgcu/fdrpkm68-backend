  ...
  const houses = await prisma.house.createManyAndReturn({
    data: [
...

      {
        ...
        tiktok:
          "https://www.tiktok.com/@baansod.official?_t=ZS-8xVFMAFa5Dz&_r=1",
        sizeLetter: "L",
        capacity: 324,
      },
...

      {
        ...
        facebook: "https://www.facebook.com/BaanKhunNooCU/?locale=th_TH",
        instagram:
...

      {
        ...
        tiktok:
          "https://www.tiktok.com/@baanjijah.chula?_t=ZS-8xhNCNKRyGw&_r=1",
        sizeLetter: "M",
        capacity: 204,
      },

      {
        ...
        facebook: "https://www.facebook.com/profile.php?id=100081054411606",
...

      {
        ...
        facebook: "https://www.facebook.com/share/15RiHeYCe3/?mibextid=qi2Omg",
        instagram:
...

      {
        ...
        tiktok:
          "https://www.tiktok.com/@baanrangs.official?_t=ZS-8xilJ9bF2Kl&_r=1",
        sizeLetter: "XXL",
        capacity: 888,
      },

      {
        ...
        facebook: "",
        instagram: "https://www.instagram.com/baan.haaw?igsh=bzlpaHluM2g1dXp1",
...

      {
        ...
        facebook: "https://www.facebook.com/share/16eBjzCqXq/?mibextid=wwXIfr",
        instagram:
...

      {
        ...
        tiktok:
          "https://www.tiktok.com/@baankids.official?_t=ZS-8xiqNbEO1WE&_r=1",
        sizeLetter: "M",
        capacity: 210,
      },
...

      {
        ...
        nameEnglish: "Baan SoeiteeLheemouy",
        descriptionThai:
      ...
      {
        nameThai: "บ้านยิ้ม",
        nameEnglish: "Baan Yim",
        descriptionThai: "ลักยิ้มที่ว่าน่ารัก หรือจะสู้ความรักที่มาจากบ้านยิ้ม",
        descriptionEnglish:
          "Who's got that cute smile? 😝🙋🏻\u200d♀️\nWell then, time to join BaanYim the House of Smiles, right? ",
        facebook: "https://www.facebook.com/profile.php?id=100067133496337",
        instagram:
